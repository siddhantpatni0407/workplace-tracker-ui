    ...
    <div className="notfound-container d-flex align-items-center justify-content-center min-vh-100 text-center">
      <div className="card shadow-lg p-5 notfound-card">
        ...
        <div className="d-flex gap-3 justify-content-center">
          <Link to={ROUTES.PUBLIC.HOME} className="btn btn-primary btn-lg shadow-sm">
            Go Home
          </Link>
          <Link to={ROUTES.PUBLIC.CONTACT} className="btn btn-outline-secondary btn-lg shadow-sm">
            Contact Support
          </Link>
        </div>
      </div>
